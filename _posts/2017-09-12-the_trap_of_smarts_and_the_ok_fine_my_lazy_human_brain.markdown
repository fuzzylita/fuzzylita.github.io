---
layout: post
title:  "The 'smart' trap and my lazy, human brain"
date:   2017-09-12 15:21:57 -0400
---

A number of bad habits have surfaced for me while learning programming, and foremost among them is my tendency to jump straight to solution mode. 

I'm naturally pretty good at problem solving, so I tend to just crash in head-first and just start working. Often, the challenge miraculously gets solved with very little actual thinking on my part. 

What I'm *not* naturally good at is stopping, analyzing the problem, and breaking it down into small pieces. Obviously, this skill is pretty core to success in an engineering role, and my weakness in this is becoming increasingly apparent. 

A recent exercise was a frustrating push to start improving my habits. The lesson focused on iterating through nested hashes, and presenting the data you pull out in various ways. 
...
Unfortunately, this also means that I can be intellectually lazy about the problem, and just start solving without thinking. Fortunately for me, Flatiron's curriculum mixes up the challenges, so lazy sacks like me can't get away with that. 😅
...
To try and force myself to follow better habits, I'm working on a process I walk through before I ever poke out a line of code. I try follow these steps every time, even if I 'know' how to do what I need to do. Behold!
...
So far, it's helped. I still fall into my lazy habits if I'm tired or if I'm absolutely confident that I know what I'm doing (which is a warning sign in itself 😱) but I'm getting better!
